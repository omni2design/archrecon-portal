...
const MOBILE_TOPNAV_BG = "#101039";
const MOBILE_PAGE_BG = "#fafafa";
const MOBILE_BORDER = "#e5e5e5";
const MOBILE_PRIMARY_PINK = "#f4038b";
const MOBILE_SECONDARY_BLUE = "#003c79";
const MOBILE_TEXT_MUTED = "#6f6f6f";
const MOBILE_TEXT_INVERSE = "#ffffff";

/** Matches Figma `BottomNav` stack height: pt-24 + row ~56 + pb-24 (+ safe-area on pb). */
const MOBILE_BOTTOM_NAV_OFFSET = "calc(24px + 56px + 24px + env(safe-area-inset-bottom, 0px))";
...
function MobileBottomArea() {
  ...
  return (
    <>
      {/*
        Figma `BottomCTA` (2294:2722): gradient white → transparent, `p-24`, sits above solid nav
        (`bottom-[104px]` + safe-area extension in our layout).
      */}
      <div
        className="fixed left-0 right-0 z-[35] p-6"
        style={{
      ...
      {/*
        Figma `BottomNav` (2294:2632): solid white, border-top, `p-24` — tabs only (no gradient).
      */}
      <div
        className="fixed bottom-0 left-0 right-0 z-40 border-t border-[#e5e5e5] bg-white p-6"
        style={{
