...
function MobileQuickAction({
  ...
  const className =
    "flex min-h-[130px] w-full min-w-0 flex-col items-center justify-start gap-3 rounded-2xl border border-[#e5e5e5] bg-white p-6 text-sm font-medium text-[#00162d] shadow-sm transition hover:bg-[#f8fafc]";
                    ...
                    <defs>
                      <clipPath id="clip0_2189_6594">
                        <rect
                          ...
                          height="14.7239"
                          fill="white"
                          transform="translate(8.6377 8.6377)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
